...
public class Principal {
    ...
    private final String API_KEY = "&apikey=dceea552";
    ...
    private void buscarEpisodioPorSerie() {
        ...
        mostrarSeriesBuscadas();
        System.out.println("Escribe los datos de la serie a buscar los episodios" );
        var nombreSerie = teclado.nextLine();
...
//                .collect(Collectors.toList());
    ...
    public void filtrarSeriesPorTemporadaYEvaluacion(){
        ...
        var totalTemporadas = teclado.nextDouble();
        teclado.nextLine();
        System.out.println("¿Comienza la evaluación a partir de cuál valor? ");
        var evaluacion = teclado.nextDouble();
        teclado.nextLine();
        List<Serie> filtroSeries = repositorio.seriesPorTemporadaYEvaluacion((int) totalTemporadas,evaluacion);
